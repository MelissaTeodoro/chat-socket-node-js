    ...
    var addContato = function(arr){
        ...
        for(i = 0; i < arr.length; i++){
            if(arr[i] != nome && arr[i] != null && arr[i] != ""){
                elmHTML += `<li class="contato id${i}" userName="${arr[i]}" userID="${i}"><div id="imagem"><img src="imagem/pessoa.png" /></div><div id="texto"><h1>${arr[i]} <span class="number of" num="0">0</span></h1></div></li>`;
                count += 1;
            }
        }
